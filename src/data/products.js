const products = [
  ...
  },
  {
    ...
    gallery: [
      ...
      { type: "image", src: "https://m.media-amazon.com/images/I/61+WppxOpdL.jpg", alt: "Transparent Wireless Mouse — lifestyle view" },
      { type: "image", src: "https://m.media-amazon.com/images/I/71oUFlTW3UL._SL1200_.jpg", alt: "Transparent Wireless Mouse — internal components" },
      { type: "image", src: "https://m.media-amazon.com/images/I/61jUzTfXiEL._SL1200_.jpg", alt: "Transparent Wireless Mouse — side profile and grip" },
    ],
    description: "A sleek and futuristic transparent wireless mouse featuring a crystal-clear magnetic casing, silent click switches, multi-device Bluetooth & 2.4GHz dual connectivity, and vibrant RGB breathing light. Perfect for clean minimalist desk setups and high-productivity workflows.",
    affiliate: "https://link.amazon/B0dtEkxMv",
    specs: [
      { label: "Connectivity", value: "Bluetooth 5.1 + 2.4GHz Wireless" },
      { label: "Design", value: "Transparent Magnetic Shell" },
      { label: "DPI Levels", value: "800 / 1200 / 1600 / 2400 Adjustable" },
      { label: "Battery", value: "Rechargeable via Type-C" },
      { label: "Click Type", value: "Ultra-Quiet Silent Switches" },
    ]
  },
  {
    id: 4,
